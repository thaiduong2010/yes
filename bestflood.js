...
'Last-Modified' : httpTime,
  'If-Modified-Since': httpTime,
'If-None-Match' : `"${randstr(20)}+${randstr(6)}="`,
'CF-IPCountry': country[Math.floor(Math.random() * country.length)],
'CF-NationCountry' : country[Math.floor(Math.random() * country.length)],
'X-ASN-IP' : country[Math.floor(Math.random() * country.length)],
...
"x-device-id" : `"device-${Math.floor(Math.random() * 10000)}"`,
"x-session-token" : `"session-token-${Math.random().toString(36).substring(2, 15)}"`,...(methods === "POST" && { "content-length": randstra(3)}),
...(methods === "POST" && { "content-type": "application/x-www-form-urlencoded"}),
...(methods === "POST" && { "location": parsedTarget.path}),

...(methods === "HEAD" && { "accept-ranges": "bytes"}),
...(methods === "HEAD" && { "content-length": randstra(4)}),
...(methods === "HEAD" && { "content-type": "text/html; charset=UTF-8"}),
...(methods === "HEAD" && { "X-RateLimit-Limit": randstra(5)}),
...(methods === "HEAD" && { "X-RateLimit-Remaining": randstra(2)}),
...(methods === "HEAD" && { "X-RateLimit-Reset": timestamp}),
...(methods === "HEAD" && { "Retry-After": "10"}),
}



let headercloudflare2 = {
'X-Download-Options' : Math.random() > 0.5 ? "open" : "noopen",
'X-Envoy-Upstream-Service-Time' : randstra(2),
'X-Permitted-Cross-Domain-Policies' : "none",
'X-Request-Id' : randstr(8) + "-" + randstr(4) + "-" + randstr(4) + "-" + randstr(4) + "-" + randstr(12),
'X-Runtime': randstra(1) + "." + randstra(6),
...
function random() {
 ...
 ['cookie'] : `cf_clearance=${generateRandomString(22,25)}_${randstra(1)}.${randstra(3)}.${generateRandomString(14,17)}-${timestampString}-1.0-${generateRandomString(6,8)}+${generateRandomString(65,85)}=`,
 }; 
 ...
 HeadersResponse = {
  ...
  ['X-Frame-Options'] : "SAMEORIGIN",
  ['X-Xss-Protection'] : generateRandomString(22) + "mode=block; report=" + randstr(11),
 ...
 HeadersResponse = {
  ...
  ['X-Content-Type-Options'] : "nosniff",
  ['X-Frame-Options'] : "SAMEORIGIN",
  ['X-Xss-Protection'] : randstr(22) + "mode=block; report=" + generateRandomString(11),
 ['cookie'] : `akamai_secure=${generateRandomString(22,25)}_${randstra(1)}.${randstra(3)}.${generateRandomString(14,17)}-${timestampString}-1.0-${generateRandomString(6,8)}+${generateRandomString(65,85)}=`,
 }; 
